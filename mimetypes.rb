MIMETYPES = {
  ...
  "video/ms-asf" => "Microsoft Advanced Systems Format (ASF)",
  ...
  "application/gzip" => "Zip Archive(application/gzip)",
  "application/zlib" => "Zip Archive",
  "application/zip-compressed" => "Zip Archive(application/zip-compressed)",
